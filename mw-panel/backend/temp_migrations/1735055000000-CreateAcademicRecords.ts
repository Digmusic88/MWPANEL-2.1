...
export class CreateAcademicRecords1735055000000 implements MigrationInterface {
  name = 'CreateAcademicRecords1735055000000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    // Create academic_record_entries table
    await queryRunner.query(`
    ...
    // Create academic_record_grades table
    await queryRunner.query(`
