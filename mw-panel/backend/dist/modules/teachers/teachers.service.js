...
let TeachersService = class TeachersService {
    ...
    async update(id, updateTeacherDto) {
        ...
        const { employeeNumber, specialties, email, isActive, firstName, lastName, dateOfBirth, documentNumber, phone, address, education, hireDate, department, position, } = updateTeacherDto;
