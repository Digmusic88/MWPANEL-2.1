...
exports.seedCommunications = void 0;
...
const seedCommunications = async (dataSource) => {
    ...
    const notificationRepository = dataSource.getRepository(notification_entity_1.Notification);
    ...
    const families = await userRepository.find({
        where: { role: user_entity_1.UserRole.FAMILY },
        relations: ['profile'],
        take: 3,
    });
    ...
    const sampleMessages = [
        {
            ...
            priority: message_entity_1.MessagePriority.NORMAL,
        ...
        },
        {
            sender: admin,
            recipient: families[0],
            type: message_entity_1.MessageType.ANNOUNCEMENT,
            priority: message_entity_1.MessagePriority.HIGH,
    ...
    const sampleNotifications = [
        {
            ...
            relatedStudent: students[0],
            type: notification_entity_1.NotificationType.EVALUATION,
        ...
        },
        {
            user: families[0],
            triggeredBy: admin,
            type: notification_entity_1.NotificationType.ACADEMIC,
        ...
        {
            user: families[2],
            type: notification_entity_1.NotificationType.REMINDER,
        ...
        try {
            ...
            if (!existingNotification) {
                const notification = notificationRepository.create({
                    ...
                    status: Math.random() > 0.7 ? notification_entity_1.NotificationStatus.READ : notification_entity_1.NotificationStatus.UNREAD,
    ...
    if (classGroups.length > 0) {
        try {
            const groupMessage = messageRepository.create({
                ...
                type: message_entity_1.MessageType.GROUP,
                priority: message_entity_1.MessagePriority.NORMAL,
...
//# sourceMappingURL=09-communications.seed.js.map