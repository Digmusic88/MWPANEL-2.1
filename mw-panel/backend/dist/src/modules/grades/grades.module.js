...
const competency_evaluation_entity_1 = require("../evaluations/entities/competency-evaluation.entity");
...
const family_entity_2 = require("../users/entities/family.entity");
    ...
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([
                ...
                task_submission_entity_1.TaskSubmission,
