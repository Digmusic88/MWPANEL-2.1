...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Obtener datos del profesor logueado' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Datos del profesor' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Profesor creado exitosamente' }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Datos inválidos' }),
    (0, swagger_1.ApiResponse)({ status: 409, description: 'Email o número de empleado ya existe' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Lista de profesores' }),
    __metadata("design:type", Function),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, roles_decorator_1.Roles)(user_entity_1.UserRole.ADMIN, user_entity_1.UserRole.TEACHER),
    (0, swagger_1.ApiOperation)({ summary: 'Obtener un profesor por ID' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Datos del profesor' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Profesor no encontrado' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Profesor actualizado exitosamente' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Profesor no encontrado' }),
    (0, swagger_1.ApiResponse)({ status: 409, description: 'Email o número de empleado ya existe' }),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Eliminar un profesor (soft delete)' }),
    (0, swagger_1.ApiResponse)({ status: 204, description: 'Profesor eliminado exitosamente' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Profesor no encontrado' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
...
__decorate([
    (0, common_1.Get)('dashboard/my-dashboard'),
    (0, roles_decorator_1.Roles)(user_entity_1.UserRole.TEACHER),
    (0, swagger_1.ApiOperation)({ summary: 'Obtener datos del dashboard del profesor actual' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Datos del dashboard del profesor' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Profesor no encontrado' }),
    __param(0, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], TeachersController.prototype, "getMyDashboard", null);
