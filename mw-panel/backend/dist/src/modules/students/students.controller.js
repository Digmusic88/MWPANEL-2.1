...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Obtener mi perfil de estudiante' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Datos del estudiante actual' }),
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], StudentsController.prototype, "changeMyPassword", null);
__decorate([
    (0, common_1.Patch)(':id'),
