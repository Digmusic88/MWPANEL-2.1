...
export declare class ClassGroupsService {
    ...
    findByTeacherUserId(userId: string): Promise<ClassGroup[]>;
    ...
    findTeacherClasses(teacherId: string): Promise<ClassGroup[]>;
    findTeacherClassesByUserId(userId: string): Promise<ClassGroup[]>;
}
