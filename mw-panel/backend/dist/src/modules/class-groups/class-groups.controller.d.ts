...
export declare class ClassGroupsController {
    ...
    findMyClasses(req: any): Promise<import("../students/entities/class-group.entity").ClassGroup[]>;
    ...
    getMyGroups(req: any): Promise<import("../students/entities/class-group.entity").ClassGroup[]>;
