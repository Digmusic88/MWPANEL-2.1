...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Obtener grupos de clase del profesor actual' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Lista de grupos de clase del profesor' }),
    (0, roles_decorator_1.Roles)(user_entity_1.UserRole.TEACHER),
    __param(0, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], ClassGroupsController.prototype, "findMyClasses", null);
__decorate([
    (0, common_1.Get)(),
...
__decorate([
    (0, common_1.Get)('teacher/my-groups'),
    (0, swagger_1.ApiOperation)({ summary: 'Obtener grupos de clase del profesor autenticado' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Lista de grupos del profesor' }),
    (0, roles_decorator_1.Roles)(user_entity_1.UserRole.TEACHER),
    __param(0, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], ClassGroupsController.prototype, "getMyGroups", null);
__decorate([
    (0, common_1.Get)(':id'),
